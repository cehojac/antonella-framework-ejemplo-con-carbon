...
class Config
{
    ...
    * @example ['post_data'=>'ECC::function']
    */
    public $post=[];
    /**
    * GET data process
    * get the get data and execute the function
    * @example ['get_data'=>'ECC::function']
    */
    public $get=[];
    /**
    * add_filter data functions
    * @input array
    * @example ['body_class','ECC::function',10,2]
    * @example ['body_class',['ECC','function'],10,2]
    */
    public $add_filter=[];
    /**
    ...
    * @input array
    * @example [['example','ECC\ExampleController::example_shortcode']]
    */
    public $shortcodes=[
        ['undia',__NAMESPACE__.'\CarbonController::index']
    ];
    /**
    * Dashboard
